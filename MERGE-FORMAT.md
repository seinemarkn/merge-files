...
`skip_extensions` (list of extensions to drop during **directory expansion**,
e.g. `[".log", ".min.js"]` — case-insensitive, leading dot optional, compound
extensions supported; files named explicitly on the command line are always
kept). Example:
